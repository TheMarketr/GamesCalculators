...
function ReferenceExplorer({ gameSlug, toolSlug, toolName }: Props) {
  ...
  const contextColumn = isMm2 ? 'Demand' : isGtaReference ? 'Evidence scope' : 'Rating / context';
