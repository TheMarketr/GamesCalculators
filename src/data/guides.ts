...
const originalGuides: GuideConfig[] = [
  { slug: 'pokemon-go/how-cp-works', gameSlug: 'pokemon-go', game: 'Pokémon GO', title: 'How Pokémon GO CP Works', description: 'Understand base stats, IVs, CP multipliers, Pokémon level and why evolution changes combat power.', category: 'Stats', readingTime: '6 min read', updated: '2026-09-05', keywords: ['how pokemon go cp works', 'pokemon go cp formula', 'pokemon level and ivs'] },
