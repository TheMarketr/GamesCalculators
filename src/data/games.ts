...
export const games: GameConfig[] = [
  {
    ...
    planned: ['Mutation Calculator', 'Profit Calculator', 'Crop Comparison', 'Prices', 'Items', 'Pets', 'Best Crops'],
  },
  {
    ...
    planned: ['Damage Calculator', 'Stat Calculator', 'Build Calculator', 'Mastery Calculator', 'Fruit Values', 'Fruit Comparison', 'Best Fruits', 'Trading Guide'],
  },
  {
    ...
    planned: ['Trade Calculator', 'Income Calculator', 'Mutation Calculator', 'Rebirth Calculator', 'Values', 'Collection Tracker', 'Income Comparison'],
  },
  {
    ...
    tools: [],
    planned: ['Characters', 'Class Comparison', 'Crafting Calculator', 'Fuel Calculator', 'Food Calculator', 'Progress Calculator', 'Run Planner', 'Codes', 'Items', 'Crafting'],
  },
  {
    ...
    planned: ['Trade Calculator', 'Pet Value Calculator', 'Neon Calculator', 'Mega Neon Calculator', 'Age Calculator', 'Egg Odds Calculator', 'Pet Values', 'Inventory Calculator'],
  },
  {
    ...
    tools: [],
    planned: ['Value Calculator', 'Value List', 'Trade Calculator', 'Trading Values', 'Knife Values', 'Inventory Calculator', 'Weapon Comparison', 'Crate Odds Calculator', 'Godly Values', 'Collection Tracker'],
  },
  {
    ...
    tools: [],
    planned: ['Value Calculator', 'Trade Calculator', 'Pet Values', 'Hatch Odds Calculator', 'Power Calculator', 'Pet Comparison', 'Enchant Calculator', 'Diamond Calculator', 'Inventory Calculator', 'Pets'],
  },
  {
    ...
    planned: ['Nether Coordinates Calculator', 'Coordinates Calculator', 'Anvil Calculator', 'Dome Calculator', 'Sphere Calculator', 'Distance Calculator', 'Damage Calculator', 'Spiral Staircase Calculator', 'Stack Calculator', 'Oval Generator'],
  },
  {
    ...
    planned: ['Account Value Calculator', 'eDPI Calculator', 'Sensitivity Calculator', 'Level Calculator', 'Battle Pass Calculator', 'TTK Calculator', 'Weapon Comparison', 'XP Per Level'],
  },
  {
    ...
    planned: ['Cost', 'Map Size', 'Map Locations', 'Characters', 'Edition Comparison'],
  },
];
