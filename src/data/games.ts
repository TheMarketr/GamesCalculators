...
export const games: GameConfig[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: 'wfl-calculator', name: 'Adopt Me WFL Calculator (Win Fair Lose)', shortName: 'WFL Calculator', description: 'Compare Adopt Me pet offers and see a transparent Win, Fair or Lose result with both value totals.', kind: 'wfl', category: 'Trading', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['wfl', 'adopt me wfl', 'win fair lose', 'trade calculator'] },
  ...
  },
  {
    ...
    tools: [
      { slug: 'cp-calculator', name: 'Pokémon GO CP Calculator', shortName: 'CP Calculator', description: 'Calculate Pokémon GO CP, HP and effective stats from species, level and exact IVs.', kind: 'pokemon-go', category: 'Stats', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['pokemon go cp calculator', 'calculator pokemon go', 'combat power'], related: ['evolution-calculator', 'stats-calculator', 'power-up-calculator'] },
      { slug: 'evolution-calculator', name: 'Pokémon GO Evolution CP Calculator', shortName: 'Evolution Calculator', description: 'Predict Pokémon GO evolution CP and HP exactly from level and IVs, or estimate a possible CP range.', kind: 'pokemon-go', category: 'Evolution', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['pokemon go evolution calculator', 'pokemon go evolution cp calculator', 'evolution calculator'], related: ['cp-calculator', 'stats-calculator', 'power-up-calculator'] },
      { slug: 'stats-calculator', name: 'Pokémon GO Stats Calculator', shortName: 'Stats Calculator', description: 'Inspect Pokémon GO CP, HP, effective stats, stat product and the gap to perfect IVs.', kind: 'pokemon-go', category: 'Stats', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['pokemon go stats calculator', 'effective stats', 'stat product'], related: ['cp-calculator', 'pvp-iv-calculator', 'evolution-calculator'] },
      { slug: 'pvp-iv-calculator', name: 'Pokémon GO PvP IV Rank Calculator', shortName: 'PvP IV Calculator', description: 'Calculate Great League, Ultra League or custom-cap PvP IV rank from all 4,096 IV spreads.', kind: 'pokemon-go', category: 'PvP', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['pokemon go pvp iv calculator', 'great league iv calculator', 'great league iv rank', 'ultra league rank'], related: ['stats-calculator', 'cp-calculator', 'power-up-calculator'] },
      { slug: 'power-up-calculator', name: 'Pokémon GO Power Up Calculator', shortName: 'Power Up Calculator', description: 'Total Stardust, Candy, Candy XL, power-ups and CP gained between Pokémon levels.', kind: 'pokemon-go', category: 'Progress', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['pokemon go power up calculator', 'stardust cost', 'candy xl'], related: ['cp-calculator', 'stats-calculator', 'evolution-calculator'] },
      { slug: 'purify-calculator', name: 'Pokémon GO Purify Calculator', shortName: 'Purify Calculator', description: 'Apply the verified Pokémon GO purification IV increase and see which Shadow stats reach 15.', kind: 'pokemon-go', category: 'Stats', ...toolMeta('calculator', '2026-09-25'), keywords: ['purify calculator pokemon go', 'shadow ivs', 'purified iv'], related: ['trade-calculator', 'cp-calculator', 'stats-calculator'] },
      { slug: 'trade-calculator', name: 'Pokémon GO Trade Calculator', shortName: 'Trade Calculator', description: 'Estimate Pokémon GO trade Stardust and Candy from friendship, registration, class and catch distance.', kind: 'pokemon-go', category: 'Trading', ...toolMeta('calculator', '2026-09-25'), keywords: ['pokemon go trade calculator', 'trade stardust cost', 'trade candy'], related: ['purify-calculator', 'cp-calculator', 'evolution-calculator'] },
      { slug: 'dps-calculator', name: 'Pokémon GO DPS Calculator', shortName: 'DPS Calculator', description: 'Model Pokémon GO fast, charged and complete move-cycle DPS with separate PvE and PvP data.', kind: 'pokemon-go', category: 'Battle', ...toolMeta('calculator', '2026-09-25'), keywords: ['pokemon go dps calculator', 'moveset dps', 'raid damage'], related: ['stats-calculator', 'cp-calculator', 'pvp-iv-calculator'] },
      { slug: 'xp-calculator', name: 'Pokémon GO Trainer XP Calculator', shortName: 'XP Calculator', description: 'Calculate Pokémon GO Trainer XP through level 80, including remaining XP, levels and action estimates.', kind: 'pokemon-go', category: 'Progress', ...toolMeta('calculator', '2026-09-25'), keywords: ['pokemon go xp calculator', 'pokemon go level 80 xp', 'trainer level xp', 'xp remaining'], related: ['power-up-calculator', 'cp-calculator', 'evolution-calculator'] },
    ],
  },
  {
    ...
    tools: [
      ...
      { slug: 'xp-calculator', name: 'OSRS XP Calculator', shortName: 'XP Calculator', description: 'Convert exact OSRS levels and total XP in either direction with the official experience curve.', kind: 'osrs', category: 'Skills', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['osrs xp calculator', 'osrs level calculator', 'xp to level'], related: ['xp-table', 'skill-calculator', 'construction-calculator'] },
      { slug: 'xp-table', name: 'OSRS XP Table (Levels 1–99)', shortName: 'XP Table', description: 'Look up every OSRS level 1–99 total XP threshold and the experience needed from the previous level.', kind: 'osrs', category: 'Skills', ...toolMeta('reference', '2026-09-25'), keywords: ['osrs xp table', 'osrs exp table', 'osrs level xp chart'], related: ['xp-calculator', 'skill-calculator', 'zmi-calculator'] },
      ...
      { slug: 'alch-calculator', name: 'OSRS High Alchemy Calculator', shortName: 'High Alchemy Calculator', description: 'Search a September 25 local GE snapshot and calculate High Alchemy profit after Nature runes.', kind: 'osrs', category: 'Economy', ...toolMeta('calculator', '2026-09-25'), keywords: ['osrs alch calculator', 'high alch profit', 'ge alchemy'], related: ['xp-calculator', 'skill-calculator', 'smithing-calculator'] },
      { slug: 'gear-calculator', name: 'OSRS Gear Calculator', shortName: 'Gear Calculator', description: 'Assemble and compare two eleven-slot equipment setups with a dated local GE price snapshot.', kind: 'osrs', category: 'Combat', ...toolMeta('calculator', '2026-09-25'), keywords: ['osrs gear calculator', 'equipment bonuses', 'gear comparison'], related: ['dps-calculator', 'max-hit-calculator', 'combat-level-calculator'] },
      ...
      { slug: 'zmi-calculator', name: 'OSRS ZMI Calculator (Ourania Altar)', shortName: 'ZMI Calculator', description: 'Calculate pure or daeyalt essence, Runecraft XP and hours using current Ourania Altar level bands.', kind: 'osrs', category: 'Skills', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['osrs zmi calc', 'zmi calculator', 'zmi altar calculator', 'ourania altar calculator', 'runecraft xp'], related: ['xp-calculator', 'xp-table', 'skill-calculator'] },
  ...
  },
  {
    ...
    tools: [
      { slug: 'breeding-calculator', name: 'Palworld Breeding Calculator', shortName: 'Breeding Calculator', description: 'Find the Palworld 1.0 child from 299 Pals, current CombiRanks and 164 special combinations.', kind: 'palworld', category: 'Breeding', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['palworld breeding calculator', 'palworld calculator breeding', 'pal breeding'], related: ['reverse-breeding-calculator', 'passive-inheritance-calculator', 'breeding-combos'] },
      { slug: 'iv-calculator', name: 'Palworld IV & Potential Calculator', shortName: 'IV Calculator', description: 'Estimate Palworld HP, Attack and Defense Potential ranges from rounded displayed Pal stats.', kind: 'palworld', category: 'Stats', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['palworld iv calculator', 'palworld potential', 'palworld potential calculator'], related: ['stat-calculator', 'breeding-calculator', 'passive-inheritance-calculator'] },
      { slug: 'reverse-breeding-calculator', name: 'Palworld Reverse Breeding Calculator', shortName: 'Reverse Breeding', description: 'Search Palworld 1.0 parent pairs for a desired child and prioritize Pals you own.', kind: 'palworld', category: 'Breeding', featured: true, ...toolMeta('calculator', '2026-09-25'), keywords: ['palworld reverse breeding calculator', 'pal parent combinations'], related: ['breeding-calculator', 'breeding-combos', 'passive-inheritance-calculator'] },
      { slug: 'passive-inheritance-calculator', name: 'Palworld Passive Inheritance Calculator', shortName: 'Passive Inheritance', description: 'Estimate desired inherited-passive odds from the unique combined parent pool.', kind: 'palworld', category: 'Breeding', ...toolMeta('calculator', '2026-09-25'), keywords: ['palworld passive inheritance calculator', 'passive breeding odds'], related: ['breeding-calculator', 'reverse-breeding-calculator', 'mutation-calculator'] },
      { slug: 'mutation-calculator', name: 'Palworld Mutation Calculator', shortName: 'Mutation Calculator', description: 'Calculate mutated-egg probability for normal or Extravagant Vegetable Cake batches.', kind: 'palworld', category: 'Breeding', ...toolMeta('calculator', '2026-09-25'), keywords: ['palworld mutation calculator', 'mutated egg chance'], related: ['breeding-calculator', 'passive-inheritance-calculator', 'breeding-combos'] },
      { slug: 'stat-calculator', name: 'Palworld Stat Calculator', shortName: 'Stat Calculator', description: 'Project HP, Attack and Defense from level, Potential, passives, Souls and Condensation.', kind: 'palworld', category: 'Stats', ...toolMeta('calculator', '2026-09-25'), keywords: ['palworld stat calculator', 'palworld pal calculator', 'potential stats'], related: ['iv-calculator', 'breeding-calculator', 'work-speed-calculator'] },
      { slug: 'work-speed-calculator', name: 'Palworld Work Speed Calculator', shortName: 'Work Speed Calculator', description: 'Compare two Work Speed setups and convert workload into completion time using current 1.0 mechanics.', kind: 'palworld', category: 'Work', ...toolMeta('calculator', '2026-09-25'), keywords: ['palworld work speed calculator', 'workload time', 'artisan work speed'], related: ['stat-calculator', 'passive-inheritance-calculator', 'breeding-calculator'] },
      { slug: 'breeding-combos', name: 'Palworld Breeding Combos', shortName: 'Breeding Combos', description: 'Search 164 current Palworld 1.0 special parent combinations with dated sourcing.', kind: 'palworld', category: 'Reference', ...toolMeta('reference', '2026-09-25'), keywords: ['palworld breeding combos', 'palworld breeding combinations'], related: ['breeding-calculator', 'reverse-breeding-calculator', 'passive-inheritance-calculator'] },
    ],
  },
  {
